...
})({"5dATB":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "33fa3c12ec5b2a67";
"use strict";
...
},{}],"7ViID":[function(require,module,exports,__globalThis) {
var _handleFilter = require("./handleFilter");
var _auth = require("./auth");
var _favorite = require("./favorite");
var _onboardingForm = require("./onboardingForm");
var _resumeClass = require("./resumeClass");
...
if (applyButton) applyButton.addEventListener("click", ()=>{
    const endpoint = window.location.pathname === "/favorites" ? "/api/v1/jobs/my-favorites" : "/api/v1/jobs";
    (0, _handleFilter.collectAndFilter)(endpoint, filterForm);
});
...
if (signupForm) signupForm.addEventListener("submit", async (e)=>{
    ...
    const success = await (0, _auth.signup)(name, email, password, role);
    if (!success) {
...
if (roleBtn) roleBtn.addEventListener("click", (e)=>{
    ...
    (0, _auth.selectRole)(selectedRole);
});
if (logoutBtn) logoutBtn.addEventListener("click", (0, _auth.logout));
if (onboardingForm) new (0, _onboardingForm.OnboardingForm)(onboardingForm);
document.addEventListener("click", async (e)=>{
    const favoriteBtn = e.target.closest(".job-card__favorite, .job-detail__favorite");
    if (!favoriteBtn) return;
    (0, _favorite.handleFavorite)(favoriteBtn);
});
if (jobApplyBtn) new (0, _resumeClass.JobApplicationModal)();

},{"./handleFilter":"4CfiQ","./auth":"1s4BN","./favorite":"htqgh","./onboardingForm":"fLmfw","./resumeClass":"d9Mia"}],"4CfiQ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "collectAndFilter", ()=>collectAndFilter);
parcelHelpers.export(exports, "displayJobs", ()=>displayJobs);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
const collectAndFilter = (endpoint = "/api/v1/jobs", filterForm)=>{
    ...
    if (experience.length > 0) queryParams.append("experience[in]", experience.join(","));
    // Handle locationType (multiple selections)
    const locationType = formData.getAll("locationType");
    if (locationType.length > 0) queryParams.append("locationType[in]", locationType.join(","));
    // Handle salary ranges
    const salary = formData.get("salary");
    if (salary) {
        if (salary === "under-1000") queryParams.append("minSalary[lt]", "1000");
        ...
        } else if (salary === "above-50000") queryParams.append("minSalary[gt]", "50000");
    }
...
const displayJobs = async (jobs)=>{
    ...
    try {
        ...
        if (response.data.status === "success") favoriteJobs = response.data.data.jobs.map((job)=>job._id.toString());
    } catch (error) {
        console.error("User not authenticated or error fetching favorite jobs:", error.response?.data?.message);
    }
    ...
    jobs.forEach((job)=>{
        ...
        const favImage = isFavorite ? "/img/general/favorite-active.svg" : "/img/general/favorite-default.svg";
      ...
      <div class="job-card__header">
        <div class="job-card__left">
          <div class="job-card__logo">
            ${job.recruiterId?.company?.logo?.url ? `<img class="job-card__logo" src="${job.recruiterId.company.logo.url}" alt="${job.recruiterId.company.name} logo">` : `<img class="job-card__logo default-image" src="/img/company/defaultcompany.svg" alt="Company logo">`}
          </div>
          <div class="job-card__info">
            <a href='/job/${job._id}' class="job-card__title">${job.title}</a>
            <div class="job-card__meta">
              <span>\u{2022} ${job.recruiterId?.company?.name || "Unknown Company"}</span>
              <span>\u{2022} ${job.location || "N/A"}</span>
              <span>\u{2022} ${job.locationType || "N/A"}</span>
              <span class="job-card__salary">\u{2022} ${job.minSalary || 0} - ${job.maxSalary || "N/A"}</span>
            </div>
          </div>
          <button class="job-card__favorite" aria-label="Add to favorites" data-jobid="${job._id}">
      ...
      <div class="job-card__footer">
        <div class="job-card__deadline">
          <span>\u{2022} Deadline: ${job.expiringDate || "N/A"}</span>
        </div>
        <div class="job-card__posted">
          <span>\u{2022} Posted: ${new Date(job.createdAt).toLocaleDateString()}</span>
        </div>
      </div>
    `;
...
const handleFilter = async (queryParams, endpoint = "/api/v1/jobs")=>{
    try {
        ...
        if (response.data.status === "success") displayJobs(response.data.data.jobs);
        else {
            console.error("API returned error status:", response.data);
            (0, _alert.showAlert)("error", "Failed to load jobs. Please try again.");
        }
    } catch (error) {
...
},{"axios":"jo6P5","./alert":"bCI43","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bCI43":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1s4BN":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "selectRole", ()=>selectRole);
parcelHelpers.export(exports, "signup", ()=>signup);
parcelHelpers.export(exports, "login", ()=>login);
parcelHelpers.export(exports, "logout", ()=>logout);
parcelHelpers.export(exports, "applicantOnboarding", ()=>applicantOnboarding);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
(0, _axiosDefault.default).defaults.withCredentials = true;
...
const signup = async (name, email, password, role)=>{
    if (!role) {
        (0, _alert.showAlert)("error", "Please select a role first");
        window.setTimeout(()=>{
    ...
    try {
        ...
        if (response.data.status === "success") {
            ...
            console.error("API returned error status:", response.data);
            (0, _alert.showAlert)("error", "Failed Signup. Please try again.");
            return false;
        }
    } catch (err) {
...
const login = async (email, password)=>{
    try {
        ...
        if (response.data.status === "success") {
            ...
            console.error("API returned error status:", response.data);
            (0, _alert.showAlert)("error", "Failed Login. Please try again.");
        }
    } catch (err) {
        (0, _alert.showAlert)("error", err.response.data.message);
    }
...
const logout = async ()=>{
    try {
        ...
        console.err(err);
        (0, _alert.showAlert)("error", "Error logging out please try agin later");
    }
};
const applicantOnboarding = async (data)=>{
    ...
    try {
        ...
        (0, _alert.showAlert)("error", "Error onboarding please try agin later");
    }
};

},{"axios":"jo6P5","./alert":"bCI43","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"htqgh":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handleFavorite", ()=>handleFavorite);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alertJs = require("./alert.js");
const handleFavorite = async (favoriteBtn)=>{
    ...
    icon.src = isFavorite ? "/img/general/favorite-default.svg" : "/img/general/favorite-active.svg";
    jobContainer.dataset.favorite = (!isFavorite).toString();
    // Call API
    const success = await toggleFavourite(jobId);
    if (!success) {
        icon.src = isFavorite ? "/img/general/favorite-active.svg" : "/img/general/favorite-default.svg";
        jobContainer.dataset.favorite = isFavorite.toString();
    } else if (window.location.pathname === "/favorites" && isFavorite) // Remove job card on /favorites if unfavorited
...
const updateJobContainer = (jobContainer)=>{
    ...
    if (remainingJobs === 0) jobList.innerHTML = "<p>No jobs found.</p>";
};
const toggleFavourite = async (jobId)=>{
    try {
        ...
        if (response.data.status === "success") {
            (0, _alertJs.showAlert)("success", response.data.message);
            return true;
        }
    } catch (err) {
        console.error(err);
        if (err.response && err.response.status === 401 || err.response.status === 500) (0, _alertJs.showAlert)("error", "Please log in to favorite or unfavorite a job.");
        else (0, _alertJs.showAlert)("error", "Error updating favorite. Please try again.");
        return false;
    }
    return false;
};

},{"axios":"jo6P5","./alert.js":"bCI43","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fLmfw":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "OnboardingForm", ()=>OnboardingForm);
var _auth = require("./auth");
class OnboardingForm {
    ...
    bindEvents() {
        this.elements.profilePics.addEventListener("change", (e)=>this.handleProfilePicsChange(e));
        // Interest input events
        this.elements.interestInput.addEventListener("keydown", (e)=>this.handleInterestKeydown(e));
        this.elements.interestInput.addEventListener("keypress", (e)=>this.handleInterestKeypress(e));
        // Text input events
        [
            this.elements.bio,
    ...
    handleInterestKeydown(e) {
        if (e.key === "Enter") {
            ...
            if (this.interests.length < this.INTEREST_MAX) {
                ...
                if (value && !this.interests.includes(value.toLowerCase()) && this.interests.length < this.INTEREST_MAX) {
    ...
    handleInterestKeypress(e) {
        if (this.interests.length >= this.INTEREST_MAX) e.preventDefault();
    }
    ...
    renderInterests() {
        ...
        const existingTags = this.elements.tagContainer.querySelectorAll(".interest-tag");
    ...
    updateInterestLimitUI() {
        if (this.interests.length >= this.INTEREST_MAX) {
            ...
            this.elements.hintEle.textContent = "Maximum Interest reached. Remove one to add another";
            ...
            this.elements.hintEle.textContent = "Press Enter to add, click \xd7 to remove (Max 6)";
    ...
    checkFormValidity() {
        ...
        const hasValidFile = hasFile && !this.elements.profileUpload?.classList.contains("has-error");
        ...
        if (!hasAnyContent) this.elements.submitBtn.disabled = true;
        else this.elements.submitBtn.disabled = false;
    ...
    submitForm(formData) {
        (0, _auth.applicantOnboarding)(formData);
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./auth":"1s4BN"}],"d9Mia":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "JobApplicationModal", ()=>JobApplicationModal);
var _handleResumeUpload = require("./handleResumeUpload");
class JobApplicationModal {
    ...
    initEventListeners() {
        if (this.applyBtn && this.modal && this.overlay) this.applyBtn.addEventListener("click", (e)=>{
            if (this.applyBtn.tagName === "A") return; // Let <a> redirect to /login
            if (this.applyBtn.dataset.applied === "true") return;
            this.toggleModal();
        });
        if (this.closeBtn) this.closeBtn.addEventListener("click", this.toggleModal);
        if (this.overlay) this.overlay.addEventListener("click", this.toggleModal);
        if (this.uploadArea && this.fileInput) {
            this.uploadArea.addEventListener("click", ()=>this.fileInput.click());
            this.fileInput.addEventListener("change", this.handleFileSelection);
        }
        if (this.removeFileBtn) this.removeFileBtn.addEventListener("click", this.resetModal);
    ...
    handleFileSelection(e) {
        const file = e.target.files[0];
        if (!file) return;
        if (this.validateFile(file)) this.updateFileInfo(file);
        else {
            this.fileInput.value = "";
            this.submitBtn.disabled = true;
        }
    ...
    async handleSubmit() {
        ...
        this.submitBtn.disabled = true;
        const success = await (0, _handleResumeUpload.handleUpload)(this.jobId, file);
        this.submitBtn.disabled = true;
        if (success) {
            this.updateApplyButton();
            this.toggleModal();
        } else this.submitBtn.disabled = false;
    }
}

},{"./handleResumeUpload":"41zSq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"41zSq":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handleUpload", ()=>handleUpload);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alertJs = require("./alert.js");
const handleUpload = async (jobId, file)=>{
    try {
        ...
        console.log(response);
        if (response.data.status === "success") {
            (0, _alertJs.showAlert)("success", "Application submitted successfully!");
            window.location.reload();
            return true;
        }
    } catch (err) {
        console.error(err);
        if (err.response && err.response.status === 400) (0, _alertJs.showAlert)("error", err.response.data.message || "Failed to submit application.");
        else if (err.response && err.response.status === 401) (0, _alertJs.showAlert)("error", "Please log in to submit an application.");
        else (0, _alertJs.showAlert)("error", "Error submitting application. Please try again.");
        return false;
    }
    return false;
...
},{"axios":"jo6P5","./alert.js":"bCI43","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5dATB","7ViID"], "7ViID", "parcelRequire7fd7", {})
